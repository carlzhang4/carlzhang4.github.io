...
profiles:
  - icon: at-symbol
    url: 'mailto:carlzhang4@zju.edu.cn'
    label: E-mail Me
  # - icon: brands/x
  ...
  - icon: academicons/google-scholar
    url: https://scholar.google.com/citations?user=UAudHtwAAAAJ&hl=zh-CN
...
education:
  - area: PhD
    ...
    date_end: 2025-06-30
    summary: |
      Supervised by [Prof Zeke Wang](https://wangzeke.github.io/).
    # button:
    #   text: 'Read Thesis'
